                ...
                <div class="panel-body">
                    <div class="col-md-9">
                        <form class="form-horizontal" role="form" style="margin-left: 20px;margin-top: 20px">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-md-3 col-xs-4" for="phone-number"> Status</label>
                                <div class="col-sm-6 col-md-6 col-xs-5">
                                    <label class="text-primary" for="phone_number_value">{{$user->members->status->staus_descripton}}</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 col-md-3 col-xs-4" for="contract-expiry-date">Since</label>
                                <div class="col-sm-6 col-md-6 col-xs-5">
                                    <label class="text-primary"
                                           for="contract_expiry_date_value">{{$user->member->year}}</label>
                                </div>
                            </div>
