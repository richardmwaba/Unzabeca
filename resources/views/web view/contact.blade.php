            ...
            <div class="contact-us-wrapper">
                ...
                <div class="directions-wrapper">
                    <div class="contact-directions">
                        ...
                        <p>Dramatically re-enginner high standards in human capital vis-a-vis cross functional networks credibly.</p>
                    </div>
                    ...
                    <div class="contact-directions">
                        <h2>By Helicopter</h2>
                        <p>Seamlessly architect timely 'outside the box thinking for sticky outsourcing continually extend businees solutions.</p>
                    </div>

                    <div class="contact-directions">
                        <h2>By Car</h2>
                        <p>If you are driving north on Sixth Avenue, turn right 44th street, right on Fifth Avenue, and right on 43rd Street. The PRIMEX is on the right. If you are driving south on Fifth Avenue, turn right 43rd Street. The primex is on the right.</p>
                    </div>

                    <div class="contact-directions">
                        <h2>Parking</h2>
                        <p>Special discount rates are available at the ABC parking garage located across the street from the Primex at the Grace Building (enter at 38 west 43rd street between 5th and 7th Avenues</p>
                    </div>

                    <div class="contact-directions">
                        <h2>By Bus</h2>
                        <p>The A2, A3, A4 and A104 all stop near the University for bus and subway maps and schedules. Visit the AMt's web site.</p>
                    </div>
